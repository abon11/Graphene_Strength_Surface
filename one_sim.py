...
def main():
    ...
    parser.add_argument("--defect_frac", type=float, required=True)
    ...
    parser.add_argument("--makeplots", type=bool, required=True)
    parser.add_argument("--detailed_data", type=bool, required=True)
    ...
    test = Simulation(comm=comm, rank=rank, sheet=sheet,
                 ...
                 defect_type=args.defect_type, defect_frac=args.defect_frac, defect_random_seed=args.defect_random_seed,
                 makeplots=args.makeplots, detailed_data=args.detailed_data, fracture_window=args.fracture_window, 
